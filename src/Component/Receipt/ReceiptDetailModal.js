...
export default function ReceiptDetailModal({ receiptID }) {
            ...
            >
                <div>
                    {tinhTrang === "Thanh toán online"
                        ?
                        <ReceiptDetailOnline receipt={receipt} handleClose={handleClose} />
                        :
                        <ReceiptDetailOffline receipt={receipt} handleClose={handleClose} />
                    }
                </div>
            </Modal>
        </div >
