...
export default function ReceiptDetailOffline({ receipt, handleClose, isExport }) {
            ...
            <Box sx={style}>
                ...
                <Box ref={componentRef}>
                    ...
                    <Box sx={Info__style}>
                        ...
                        <Typography variant="h6" style={{ fontSize: 14, width: 900, paddingBottom: 0, paddingRight: 40 }}>
